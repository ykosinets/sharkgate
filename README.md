# Build Sharkgate: Static/ES6/SASS

A static website/app dashboard.
...
```
git clone git@github.com:ykosinets/sharkgate.git
cd sharkgate
npm install
```
...
Please use the [issue tracker](https://ykosinets/sharkgate/issues) to report any bugs or file feature requests.

# Author

Yurii Ksynets ([ykosinets.xyz](http://ykosinets.xyz))
